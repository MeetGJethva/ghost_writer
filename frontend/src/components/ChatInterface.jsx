...
import { Bot, User, Code, FileText, Send, X, Smartphone, Plus, MessageSquare, Trash2, Folder, ChevronDown, ChevronRight, Layout, Activity, CheckCircle, Clock, AlertCircle, RefreshCw, ListTodo, Briefcase, Paperclip } from 'lucide-react';
