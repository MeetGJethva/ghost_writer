...
class CodeGeneratorAgent:
    ...
    def run(
        ...
        system_context = (
            ...
            f"INSTRUCTIONS:\n"
            f"- NEVER use 'read_file' for files listed in PRE-LOADED FILES above.\n"
            f"- Only use 'read_file' for files NOT listed above that you need to inspect. For large files, use start_line/end_line.\n"
            f"- **BATCH UPDATES**: For existing files, you MUST use 'replace_multiple_contents'. If a file requires multiple changes, provide them as a list in a single tool call to minimize I/O operations.\n"
            f"- Ensure the 'search' strings in your updates match the file content exactly, including indentation and whitespace.\n"
